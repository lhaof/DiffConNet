...
class UNETR(SegmentationNetwork):
    ...
    def __init__(
        ...
        self.ds4_cls_conv = nn.Conv3d(768, 4, kernel_size=1)
    ...
    def forward(self, x_in):
        ...
        logits = []
        logits.append(out)
        logits.append(self.ds1_cls_conv(dec1))
        logits.append(self.ds2_cls_conv(dec2))
        logits.append(self.ds3_cls_conv(dec3))
