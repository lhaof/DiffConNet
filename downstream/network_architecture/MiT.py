...
class MiT(nn.Module):
    ...
    def __init__(self, norm_cfg='BN', activation_cfg='ReLU', weight_std=False, img_size=[48, 192, 192], num_classes=None, in_chans=3, 
    ...
    def forward(self, inputs):
        ...
        W = W - 1
        skip0 = x_encoder[-2]
        x = x[:,80:-80,:] + skip0.flatten(2).transpose(1, 2)
...
class MiTnet(SegmentationNetwork):
    ...
    def __init__(self, norm_cfg='BN', activation_cfg='ReLU', weight_std=False, img_size=None, num_classes=None, in_chans=4, 
        ...
        if pretrain:
            ...
            if model_dict['transformer.patch_embed0.conv.weight'].shape[1] != 1:
                print('before repeat_interleave:',pre_dict_ori['transformer.patch_embed0.conv.weight'].shape)
                ...
                print('after repeat_interleave:',pre_dict_ori['transformer.patch_embed0.conv.weight'].shape)
