...
import MiTnnu.network_architecture.raw_MiT.MiT_encoder as MiT_encoder
from MiTnnu.network_architecture.raw_MiT.utils import trunc_normal_
...
class MiT(nn.Module):
    ...
    def __init__(self, norm_cfg='BN', activation_cfg='ReLU', weight_std=False, img_size=[48, 192, 192], num_classes=None, in_chans=4, 
