...
# from MiTnnu.network_architecture.raw_MiT.MiT import MiTnet
from MiTnnu.network_architecture.DiT_1.MiT import DiTnet

class TrainerV2_Brats23_MEN_DiT(nnUNetTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            if force_load_plans or (self.plans is None):
                ...
                # self.plans['plans_per_stage'][0]['patch_size'] = np.array([32, 32, 32])
                # self.plans['plans_per_stage'][0]['batch_size'] = 1
    ...
    def initialize_network(self):
        ...
        self.network = DiTnet(norm_cfg=self.norm_cfg, activation_cfg=self.activation_cfg,
    ...
    def do_split(self):
        if self.fold == "all":
            ...
            splits[self.fold]['train'] = np.array(
                ['BraTS-MEN-00646-000', 'BraTS-MEN-00906-000', 'BraTS-MEN-00238-000', 'BraTS-MEN-00788-000', 'BraTS-MEN-00367-000', 'BraTS-MEN-00584-000', 'BraTS-MEN-00955-000', 'BraTS-MEN-00735-000', 
                'BraTS-MEN-00191-000', 'BraTS-MEN-00440-000', 'BraTS-MEN-01401-000', 'BraTS-MEN-00589-000', 'BraTS-MEN-00358-000', 'BraTS-MEN-01388-000', 'BraTS-MEN-00540-000', 'BraTS-MEN-00954-000', 
                'BraTS-MEN-01309-000', 'BraTS-MEN-01031-000', 'BraTS-MEN-00465-000', 'BraTS-MEN-00167-000', 'BraTS-MEN-00737-000', 'BraTS-MEN-01075-000', 'BraTS-MEN-00831-000', 'BraTS-MEN-00018-000', 
                'BraTS-MEN-01179-000', 'BraTS-MEN-00378-000', 'BraTS-MEN-00547-000', 'BraTS-MEN-01016-000', 'BraTS-MEN-00060-000', 'BraTS-MEN-00077-000', 'BraTS-MEN-00601-000', 'BraTS-MEN-00807-000', 
                'BraTS-MEN-00754-000', 'BraTS-MEN-01246-002', 'BraTS-MEN-01246-003', 'BraTS-MEN-00857-000', 'BraTS-MEN-00209-000', 'BraTS-MEN-01127-000', 'BraTS-MEN-00530-000', 'BraTS-MEN-01113-000', 
                'BraTS-MEN-01363-000', 'BraTS-MEN-01423-000', 'BraTS-MEN-00196-000', 'BraTS-MEN-00357-000', 'BraTS-MEN-00929-000', 'BraTS-MEN-01279-010', 'BraTS-MEN-00886-000', 'BraTS-MEN-01305-000', 
