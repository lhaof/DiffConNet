...
from MiTnnu.inference.predict import predict_from_folder
...
def main():
    ...
    parser.add_argument("-outpath", type=str, default='DiT_nomod_23', help='output path')
    ...
    # outpath = args.outpath + '_' + 'preprocess2' + '_' + norm_cfg + '_' + activation_cfg + '_' + str(split)
    ...
    model_folder_name = join(network_training_output_dir, model+'_'+args.plans_identifier, task_name, outpath)
